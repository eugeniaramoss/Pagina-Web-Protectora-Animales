...
<body>
    ...
    <main>
        <div>
            <h2>¡Muchas gracias por querer formar parte de nuestro proyecto! <br> Sin vosotr@s nada de esto sería
                posible. <br> Próximamente nos pondremos en contacto contigo, <br> ¡todos nuestros peludos te dan las
                gracias! </h2>
            <br>
