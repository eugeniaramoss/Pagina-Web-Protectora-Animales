...
<body>
    ...
    <main>
        <section>
            <h1>Raza</h1>
            <a href="createRaza.php"><button>+ Añadir raza</button></a>
        </section>
        <section class="tabla">
            <table>
                <thead>
                ...
                <tbody>
                    <?php
                        foreach ($resultados as $row) {
                            ...
                            echo '<td>' . $row['tipo'] . '</td>';
                            echo '<td class="acciones"><a href="deleteRaza.php?id='.$row['id'].'"><i class="fas fa-trash" style="color: #ff0000;"></i></a>  <a href="editRaza.php?id='.$row['id'].'"><i class="fas fa-edit" style="color: #ff9500;"></i></a></td>';
                            echo '</tr>';
