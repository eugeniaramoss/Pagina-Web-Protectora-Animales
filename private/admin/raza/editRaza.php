...
<body>
    ...
    <h1>Actualizar raza</h1>
    <form action="updateRaza.php" method="POST">
        <input type="hidden" value="<?php echo $raza['id']?>" name="id">
        <label id="" name="">Nombre: </label>
        <input type="text" value="<?php echo $raza['nombre']?>" name="nombre">
        <br>
        <br>
        <label id="" name="">Id del tipo: </label>
        <input type="text" value="<?php echo $raza['tipo_id']?>" name="tipo_id">
        <br>
        <br>
