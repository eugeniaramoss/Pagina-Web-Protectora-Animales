...
<body>
    ...
    <main>
        <section>
            <h1>Estado</h1>
            <a href="createEstado.php"><button>+ Añadir estado</button></a>
        </section>
        <section class="tabla">
            <table>
                <thead>
                ...
                <tbody>
                    <?php
                        foreach ($resultados as $row) {
                            ...
                            echo '<td class="acciones"><a href="deleteEstado.php?id='.$row['id'].'"><i class="fas fa-trash" style="color: #ff0000;"></i></a>  <a href="editEstado.php?id='.$row['id'].'"><i class="fas fa-edit" style="color: #ff9500;"></i></a></td>';                            
                            echo '</tr>';
                        }               
                    ?>
                </tbody>
