...
<body>
    ...
    <form action="updateProductos.php" method="POST">
        ...
        <input type="text" value="<?php echo $producto['nombre']?>" name="nombre">
        <br>
        <br>
        <label id="" name="">Precio: </label>
        <input type="text" value="<?php echo $producto['precio']?>" name="precio">
        <br>
        <br>
        <label id="" name="">Stock: </label>
        <input type="text" value="<?php echo $producto['stock']?>" name="stock">
        <br>
        <br>
        <label id="" name="">Descripción: </label>
        <input type="text" value="<?php echo $producto['descripcion']?>" name="descripcion">
        <br>
        <br>
